...
export default function () {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const url = `https://zendovo-api.chickenkiller.com/openai?` + new URLSearchParams({ idea: query });
      ...
      const productsUrl = `https://zendovo-api.chickenkiller.com/openai/products?` + new URLSearchParams({ idea: query });
